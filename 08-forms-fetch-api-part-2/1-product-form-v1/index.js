        ...
        <form data-element="productForm" class="form-grid">
          <div class="form-group form-group__half_left">
            <fieldset>
              ...
              <input data-input id="title" required="" type="text" name="title" class="form-control" placeholder="Название товара" value="${escapeHtml(
          ...
          <div class="form-group form-group__wide">
            ...
            <textarea data-input id="description" required="" class="form-control" name="description" data-element="productDescription" placeholder="Описание товара">${escapeHtml(
          ...
          <div class="form-group form-group__half_left form-group__two-col">
            <fieldset>
              ...
              <input data-input id="price" required="" type="number" name="price" class="form-control" placeholder="100" value="${
                this.productData.price
              }">
            </fieldset>
            <fieldset>
              <label class="form-label">Скидка ($)</label>
              <input data-input id="discount" required="" type="number" name="discount" class="form-control" placeholder="0" value="${
          ...
          <div class="form-group form-group__part-half">
            ...
            <input data-input id="quantity" required="" type="number" class="form-control" name="quantity" placeholder="1" value="${
          ...
          <div class="form-group form-group__part-half">
            ...
            <select data-input id="status" class="form-control" name="status">
              <option ${
                this.productData.status === 0 ? "selected" : ""
              } value="0">Неактивен</option>
              <option ${
                this.productData.status === 1 ? "selected" : ""
              } value="1">Активен</option>
            </select>
          </div>
